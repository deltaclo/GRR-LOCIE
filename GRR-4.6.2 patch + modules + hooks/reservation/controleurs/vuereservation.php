...
$GLOBALS['suivi_demandes_vuereservation_context'] = array(
    'entry_id' => isset($id) ? (int) $id : 0,
    'room_id' => isset($room_id) ? (int) $room_id : 0,
    'mode' => isset($mode) ? $mode : ''
);
$resulHook = Hook::Appel("hookVueReservation");
$d['hookVueReservation'] = isset($resulHook['hookVueReservation']) ? $resulHook['hookVueReservation'] : "";
